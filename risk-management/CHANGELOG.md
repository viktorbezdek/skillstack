...
- expand anti-patterns with solutions, add pre-mortem detail and when-to-run guidance
...
- add Use when triggers and NOT for critical-intuition/code-review/edge-case-coverage
