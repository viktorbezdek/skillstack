...
- add decision tree, expand anti-patterns, add detection heuristics, when-to-use section
...
- add Use when triggers and NOT for risk-management/code-review/testing
