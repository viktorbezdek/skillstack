...
- **Quick prototype not intended for distribution** — write the SKILL.md directly with `skill-creator`
...
- **For skills:** load `skill-creator` and follow its conventions for frontmatter, progressive disclosure, and reference files
