...
- add decision tree, 11-entry anti-patterns table, when-to-use/not with code-review NOT clause, convert verbose lists to tables
...
- add git-workflow skill with conventional commits
