# Changelog — context-fundamentals
...
- add decision tree, add anti-patterns with solutions, add context anatomy table, add when-to-use/not
...
- add 12 context engineering and agent architecture plugins

### Changed

- add 2025-2026 research references for context and memory plugins

### Fixed

- add standard keywords and expand README to full format
