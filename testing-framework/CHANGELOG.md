...
- add decision tree, When NOT to Use, anti-patterns with solutions, trim blanks, replace trigger phrases with structured guidance
...
- add testing-framework skill for multi-language testing
