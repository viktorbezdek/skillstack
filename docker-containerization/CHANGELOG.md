# Changelog — docker-containerization
...
- add decision tree, 11-entry anti-patterns table, when-to-use/not, K8s NOT clause, cut fluff
...
- add docker-containerization skill
