# Changelog — consistency-standards
...
- add decision tree, expand anti-patterns with solutions, add when-to-use/not, add cross-layer mapping
...
- add Use when triggers and NOT clauses for ontology/content/lang skills
...
- add helper skills for documentation ecosystem
