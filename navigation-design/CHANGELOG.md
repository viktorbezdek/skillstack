...
- add decision tree, expanded anti-patterns with solutions, when-to-use/not sections, IA guidance, related skills
...
- add Use when triggers and NOT for user-journey-design/ux-writing/nextjs
