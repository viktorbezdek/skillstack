...
Part of [SkillStack](https://github.com/viktorbezdek/claude-skills) — `/plugin install ontology-design@claude-skills` -- 34 production-grade skills for Claude Code.
