...
- add decision tree, expanded anti-patterns with solutions, when-to-use/not sections, inverses, axioms, related skills
...
- add explicit trigger phrases and NOT for content-modelling/consistency-standards
...
- add content modeling and ontology design skills
...
- improve helper skill descriptions and add trigger words
