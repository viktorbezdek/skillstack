...
- add decision tree, expanded anti-patterns with solutions, when-to-use/not sections, cut version footer
...
- add nextjs-development skill covering App Router and Next.js 16
