...
- add decision tree with debugging branch, expand anti-patterns with code solutions, add When NOT to Use, cut intro fluff
...
- add react-development skill with hooks and architecture
