# Changelog — creative-problem-solving
...
- add decision tree, add anti-patterns with solutions, add when-to-use/not, add technique selection guide, cut fluff
...
- add Use when trigger phrases and NOT for critical-intuition/prioritization
...
- add creative-problem-solving with game theory and lateral thinking
